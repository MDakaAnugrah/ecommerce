                            ...
                            <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                                <div class="slide-split_text position-relative d-flex align-items-center"
                                    ...
                                    <div class="slideshow-text container p-3 p-xl-5">
                                        <h2
                                            class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">Happy <br /><strong>Shopping</strong></h2>
                                        <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Shopping is essential for fulfilling basic needs, supporting economic growth, and providing convenience, social engagement, and access to diverse products and services.   </h6>
                                    </div>
                                </div>
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1"
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                            aria-label="Page Size" id="pagesize" style="margin-right: 20px" name="pagesize">
