...
class AdminController extends Controller
{
    ...
    public function add_brand_store(Request $request)
    {
        ...
        $brand -> save();
        return redirect('admin/brands')->with('status','Brand has been added succesfully!');
    }
    ...
    public function brand_update(Request $request)
    {
        ...
        $brand -> save();
        return redirect('admin/brands')->with('status','Brand has been updated succesfully!');
}
    ...
    public function category_store(Request $request)
    {
        ...
        $category -> save();
        return redirect('admin/categories')->with('status','Category has been added succesfully!');
    }
    ...
    public function category_update(Request $request)
    {
        ...
        $category -> save();
        return redirect('admin/categories')->with('status','Category has been updated succesfully!');
    }
    ...
    public function product_delete($id)
    {
        ...
        $product->delete();
        return redirect()->route('admin.products')->with('status','Product has been delete!');
    }
    ...
    public function coupon_store(Request $request)
    {
        ...
        $coupon->save();
        return redirect()->route('admin.coupons')->with('status','Coupon has been added!');
    }
    ...
    public function slide_store(Request $request)
    {
        ...
        return redirect()->route('admin.slides')->with('status','Slide add success!');
    ...
    public function slide_update(Request $request)
    {
        ...
        $slide->save();
        return redirect()->route('admin.slides')->with('status','Slide updated success!');
    }
    ...
    public function slide_delete($id)
    {
        ...
        $slide->delete();
        return redirect()->route('admin.slides')->with('status','Slide deleted success!');
    }
    ...
    public function contact_delete($id)
    {
        ...
        $contact->delete();
        return redirect()->route('admin.contacts')->with('status','Contact deleted Success!');
    }
